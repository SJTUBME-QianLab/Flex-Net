...
from tools import data_load_simu as loader
...
def get_parser():
    ...
    parser.add_argument('--data_name', type=str, default='MCAR', choices=['MCAR', 'MAR', 'MNAR'])
...
class Processor:
    ...
    def save_arg(self):
        ...
        self.data_path = os.path.join(self.arg.data_root, 'simu', 'simu_1100_' + self.arg.data_name)
        ...
        self.work_dir = os.path.join(self.arg.save_dir, 'Ours', self.arg.data_name, f'rand{self.arg.rand}',
                                     'L{:d}p{:g}'.format(self.arg.lost_num, self.arg.p_inc),
    ...
    def load_data(self):
        ...
        self.data_loader['train'] = loader.Load(
            ...
            lost_num=self.arg.lost_num, p_inc=self.arg.p_inc
        )
